        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '24px' }}>
          <div style={{ backgroundColor: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', overflow: 'hidden' }}>
            <div style={{ padding: '24px', borderBottom: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <button onClick={prevMonth} style={{ padding: '10px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '10px', cursor: 'pointer' }}>
              ...
              <button onClick={nextMonth} style={{ padding: '10px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '10px', cursor: 'pointer' }}>
            ...
            <div style={{ padding: '24px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '8px' }}>
                ...
                {[...Array(daysInMonth)].map((_, i) => {
                  ...
                  return (
                    <div key={day} style={{ padding: '10px', minHeight: '90px', borderRadius: '12px', backgroundColor: isToday ? '#dcfce7' : '#f8fafc', border: isToday ? '2px solid #00843e' : '1px solid #e2e8f0' }}>
